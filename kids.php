...
$sql = "SELECT * FROM products WHERE category_id = 3 AND is_active = 1 ORDER BY product_id";
...
<head>
    ...
    <title>Kids Collection - ReCloth</title>
    ...
    <section class="products">
        ...
        <div class="filter-bar">
            <div>
                ...
                <button class="filter-btn">Boys</button>
                <button class="filter-btn">Girls</button>
            </div>
